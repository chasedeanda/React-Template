...
/***/ function(module, exports, __webpack_require__) {
	...
	AddList = __webpack_require__(164);
	...
	var App = React.createClass({displayName: "App",
		...
		render: function(){
			var componentList = this.state.lists.map(function(list, index){
				return(
				React.createElement(ListContainer, {title: list.title, index: index, color: list.color, key: index, remove: this.removeList})
				)
			}.bind(this));
			return(
		...
		render: function(){
			...
			return(
				React.createElement("div", {className: "col-sm-6"}, 
			        React.createElement("div", {className: this.props.color, style: styles.container}, 
	...
	var AddItem = React.createClass({displayName: "AddItem",
		...
		render: function(){
			return (
				...
				React.createElement("input", {type: "text", className: "form-control", placeholder: "Enter Keyword", value: this.state.newItem, onChange: this.handleChange, onKeyDown: this.handleSubmit})
				)
			)
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),
	ColorPicker = __webpack_require__(165);
	...
	var AddList = React.createClass({displayName: "AddList",
		...
		render:  function(){
			...
			return(
				React.createElement("div", {className: "col-md-6 nofloat center-block"}, 
					React.createElement("h3", {className: "text-center"}, "Create New Category"), 
					React.createElement("input", {className: "form-control", value: this.state.listName, type: "text", placeholder: "List Name", onChange: this.handleChange, required: true}), 
					React.createElement(ColorPicker, {color: this.state.color, colorSelect: this.colorSelect}), 
					React.createElement("button", {className: "btn btn-primary", style: styles.button, onClick: this.handleSubmit}, "Submit")
				)
			)
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorPicker = React.createClass({displayName: "ColorPicker",
		...
		render: function(){
			return(
				React.createElement("div", null, 
					React.createElement("span", {className: "colorPreview"}, "List Background Color:", React.createElement("div", {className: this.props.color})), 
					React.createElement("div", {className: "colorCont"}, 
						React.createElement("span", {className: "gray", onClick: this.props.colorSelect}), 
						React.createElement("span", {className: "blue", onClick: this.props.colorSelect}), 
						React.createElement("span", {className: "green", onClick: this.props.colorSelect}), 
						React.createElement("span", {className: "tan", onClick: this.props.colorSelect}), 
						React.createElement("span", {className: "red", onClick: this.props.colorSelect})
					)
				)
			)
		}
